...
public class LaserBoss extends MovingObject {
    private int potencia;
    public static boolean bonusactive;
    private static long timer;

    public LaserBoss(Vector2D posicion, Vector2D speed, double maxSpeed, double angle, BufferedImage texture, GameState gameState, int potencia) {
